...
const PREVIEW_PROFILES = [
  { id: "f", name: "김서연", region: "서울 마포", birthYear: 1996, gender: "여", occupation: "브랜드 마케터", imageUrl: "/99년생 여자 기획자.png" },
  { id: "m", name: "박도윤", region: "판교",     birthYear: 1992, gender: "남", occupation: "백엔드 개발자",  imageUrl: "/94년생 남자 개발자.png" },
];
          ...
          >
            <CardContent className="p-4">
              ...
              <div className="px-1 pb-1 pt-4">
                <h3 className="text-foreground">{profile.name} · {profile.region}</h3>
