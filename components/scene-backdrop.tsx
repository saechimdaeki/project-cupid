export function SceneBackdrop() {
  return (
    <svg className="sceneBackdrop" viewBox="0 0 920 820" aria-hidden="true">
      ...
      <g opacity="0.7">
        <path
          d="M570 136 580 162 606 172 580 182 570 208 560 182 534 172 560 162Z"
          fill="#f0c37a"
        />
        <path
          d="M676 626 684 648 706 656 684 664 676 686 668 664 646 656 668 648Z"
          fill="#efb2bf"
        />
        <path
          d="M268 612 276 632 296 640 276 648 268 668 260 648 240 640 260 632Z"
          fill="#efb2bf"
        />
      </g>
    </svg>
