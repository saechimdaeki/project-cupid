        ...
        <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-6 px-4 pb-32 pt-24 md:pb-10 md:px-8 lg:px-12">
          <section className="flex flex-col gap-4 rounded-[34px] border border-[#ead8cf] bg-[linear-gradient(135deg,rgba(255,255,255,0.92),rgba(255,244,239,0.96))] p-6 shadow-[0_24px_70px_rgba(143,95,89,0.12)] sm:flex-row sm:items-end sm:justify-between sm:p-8">
            <div>
              ...
              <h1 className="mt-4 text-[clamp(2.2rem,9vw,4.2rem)] font-semibold tracking-[-0.08em] text-[#24161c]">
                매물 수정
              </h1>
            ...
            <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
              <Link
                className="inline-flex min-h-12 w-full items-center justify-center rounded-full border border-[#ead8cf] bg-white/90 px-5 text-sm font-semibold text-[#2d1e24]"
          ...
          <form action={updateCandidate} className="grid gap-5">
            ...
            <section className="grid gap-5 xl:grid-cols-2">
              <article className="rounded-[30px] border border-[#ead8cf] bg-white/90 p-5 shadow-[0_18px_44px_rgba(143,95,89,0.08)] sm:p-6">
                ...
                <h2 className="mt-3 text-[clamp(1.6rem,7vw,2.4rem)] font-semibold tracking-[-0.05em] text-[#24161c]">
                  기본 프로필
                </h2>
                ...
                <div className="mt-6 grid gap-4">
                  ...
                  <label className="grid gap-2">
                    ...
                    <input
                      name="heightText"
                      defaultValue={candidate.height_text}
                      className="min-h-12 rounded-2xl border border-[#ead8cf] bg-white/95 px-4 text-sm font-semibold text-[#37232b]"
                    />
                  </label>
                  ...
                  <label className="grid gap-2">
                    ...
                    <input
                      name="workSummary"
                      defaultValue={candidate.work_summary}
                      className="min-h-12 rounded-2xl border border-[#ead8cf] bg-white/95 px-4 text-sm font-semibold text-[#37232b]"
                    />
                  </label>
                  <label className="grid gap-2">
              ...
              <article className="rounded-[30px] border border-[#ead8cf] bg-white/90 p-5 shadow-[0_18px_44px_rgba(143,95,89,0.08)] sm:p-6">
                ...
                <div className="mt-6 grid gap-4">
                  <label className="grid gap-2">
                    ...
                    <textarea
                      ...
                      className="rounded-[22px] border border-[#ead8cf] bg-white/95 px-4 py-3 text-sm font-semibold text-[#37232b]"
                    />
                  </label>
                  <label className="grid gap-2">
                ...
                <div className="mt-4 rounded-2xl border border-[#f0ddd2] bg-[#fff8f3] px-4 py-4 text-sm leading-6 text-[#8a6b74]">
                  지역, 출생연도, 성별, 직업은 필수입니다. 이름은 선택입니다. 나머지는 선택
                  입력입니다.
                </div>
              </article>
            </section>
              ...
              {photos.length ? (
                <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                  {photos.map((photo) => (
                    <article
                      key={photo.id}
                      className="grid gap-3 rounded-[24px] border border-[#ead8cf] bg-[#fffaf7] p-4"
                    >
                      ...
                      <div className="grid gap-3 text-sm font-medium text-[#5f4951]">
                        ...
                        <label className="flex items-center gap-3">
                          <input type="checkbox" name="removedPhotoIds" value={photo.id} />이 사진
                          제거
                        </label>
                      </div>
                    </article>
