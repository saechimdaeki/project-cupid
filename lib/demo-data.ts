import type { CandidateProfile, MatchHistoryItem, ViewerProfile } from "@/types/domain";
...
export const demoCandidates: CandidateProfile[] = [
  ...
  },
  {
    ...
    occupation: "전략 컨설턴트",
    status: "active",
    summary: "일에 대한 집중력이 높고, 관계에서도 서로의 성장을 돕는 파트너십을 중요하게 봅니다.",
...
export const demoMatches: MatchHistoryItem[] = [
  {
    ...
    outcome: "in_progress",
    story:
      "첫 만남 이후 대화 빈도가 안정적으로 유지되고 있고, 취향 접점이 많아 다음 만남이 이어지고 있습니다.",
  },
  {
    id: "match-2",
    candidateId: "cand-1",
