        ...
        <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-6 px-4 pb-32 pt-24 md:pb-10 md:px-8 lg:px-12">
          <Card className="flex flex-col gap-4 rounded-[34px] border-border bg-gradient-to-br from-card to-secondary p-6 shadow-[0_24px_70px_rgba(143,95,89,0.12)] sm:flex-row sm:items-end sm:justify-between sm:p-8">
            <CardContent className="p-0">
              ...
              <h1 className="mt-4 text-[clamp(2.2rem,9vw,4.2rem)] font-semibold tracking-[-0.08em] text-foreground">
                새 매물 등록
              </h1>
            ...
            <section className="grid gap-5 xl:grid-cols-2">
              <Card className="rounded-[30px] border-border bg-card/90 p-5 shadow-[0_18px_44px_rgba(143,95,89,0.08)] sm:p-6">
                <CardContent className="p-0">
                  ...
                  <h2 className="mt-3 text-[clamp(1.6rem,7vw,2.4rem)] font-semibold tracking-[-0.05em] text-foreground">
                    기본 프로필
                  </h2>
                  <p className="mt-3 text-sm leading-6 text-muted-foreground">
                    필수 입력: 지역, 출생연도, 성별, 직업 · 이름은 비워두면 카드에 &quot;NN년생
                    직업&quot;만 표시됩니다.
                  </p>
                  <div className="mt-6 grid gap-4">
                    ...
                    <Label className="grid gap-2">
                      ...
                      <Input
                        name="workSummary"
                        placeholder="[선택] 예: INNOVATE · 서비스 기획"
                        className="min-h-12 rounded-2xl border-border bg-white/95 px-4 text-sm font-semibold text-foreground"
                      />
                    </Label>
                    <Label className="grid gap-2">
              ...
              <Card className="rounded-[30px] border-border bg-card/90 p-5 shadow-[0_18px_44px_rgba(143,95,89,0.08)] sm:p-6">
                <CardContent className="p-0">
                  ...
                  <div className="mt-6 grid gap-4">
                    <Label className="grid gap-2">
                      ...
                      <Textarea
                        ...
                        rows={4}
                        placeholder="[선택] 차분하고 센스가 있으며..."
                        className="rounded-[22px] border-border bg-white/95 px-4 py-3 text-sm font-semibold text-foreground"
                      />
                    </Label>
                    <Label className="grid gap-2">
                    ...
                    <Label className="grid gap-2">
                      ...
                      <Input
                        name="highlightTags"
                        placeholder="[선택] 예: 대화잘함, 서울거주, 비흡연"
                        className="min-h-12 rounded-2xl border-border bg-white/95 px-4 text-sm font-semibold text-foreground"
                      />
                    </Label>
                  ...
                  <div className="mt-4 rounded-2xl border border-border bg-secondary px-4 py-4 text-sm leading-6 text-muted-foreground">
                    지역, 출생연도, 성별, 직업은 필수입니다. 이름은 알 수 없으면 비워도 됩니다.
                    나머지는 선택 입력입니다. 사진은 private bucket에 저장되고, 상세 화면에서는
                    signed URL로만 열립니다.
                  </div>
                </CardContent>
              </Card>
