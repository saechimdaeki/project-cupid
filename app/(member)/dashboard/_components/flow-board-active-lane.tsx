...
export function FlowBoardActiveLaneContent({
  ...
  return (
    <div className="mt-4 grid min-h-0 flex-1 grid-cols-2 gap-x-3 gap-y-4 overflow-y-auto -mx-5 px-5 -mb-5 pb-5 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-rose-200/60">
      <div className="min-w-0">
        <p className={cn("mb-2 flex shrink-0 items-center gap-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-blue-400/80")}>
          <span>🤵</span> 남성
        </p>
